    ...
    return(
        <div className='add-cabin'>
            <Form onSubmit={handleSubmit(onSubmit)}>
               <Container>
                    <Row>
                        <h3 className='add-cabin__header'>Legg til ny hytte</h3>
                        ...
                        <Col lg='6' md='6' sm='12' className='add-cabin__number-input add-cabin__number-input--measures'>
                            <p>Mål: </p>
                            <Form.Group className='add-cabin__item'>
                        ...
                        <Form.Group className='add-cabin__item'>
                            ...
                            <Col>
                                <Form.Group className='add-cabin__item'>
                                    <Form.Control name='img1' type='text' placeholder='Bilde URL' ref={register({ required: true })}/>
                                    {errors.img1 && <p className="add-cabin__error">Hytten må ha minst ett bilde</p>}
                                </Form.Group>
                            </Col>
                            <Col>
                                <Form.Group className='add-cabin__item'>
                                    <Form.Control name='img2' type='text' placeholder='Bilde URL' ref={register({ required: true })}/>
                                    {errors.img1 && <p className="add-cabin__error">Hytten må ha minst ett bilde</p>}
                                </Form.Group>
                            </Col>
                            <Col>
                                <Form.Group className='add-cabin__item'>
                                    <Form.Control className='' name='img3' type='text' placeholder='Bilde URL' ref={register({ required: true })}/>
                                </Form.Group>
                            </Col>
                        <Form.Group className='add-cabin__item add-cabin__item--submit'>
                            <Button type='submit'>
